...
with open(
    r"F:\GITLAB\DataForge\output\pangu\bxf\ODS_BEIAN_MARKETPLACE_INFO.json",
    mode="r",
    encoding="utf-8",
) as tb_r:
...
with open(
    r"F:\GITLAB\DataForge\output\fake_sample_data\ODS_BEIAN_MARKETPLACE_INFO.json",
    mode="r",
    encoding="utf-8",
) as faker_r:
...
print(
    f"insert into fmdbmeta.ODS_BEIAN_MARKETPLACE_INFO values {tuple(first_value)}, {tuple(second_value)}, {tuple(third_value)};"
)
