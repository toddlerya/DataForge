...
class LogManager:
    def __init__(
        ...
        log_format=(
            ...
            "<yellow>[{extra[trace_uuid]}]</yellow>  | "
        ...
        Args:
            ...
            log_path (str): 存放日志文件的目录,
             举个例子, 可以设置为logs, `base_path`的相对子级路径
            log_name (str): 日志文件的名称, 比如task.log
            log_format (str, optional): 日志内容的格式默认为. Defaults to
             "{time:YYYY-MM-DD HH:mm:ss} {module} {function} {level} {message} {line}"
            ...
            compression (str, optional): 历史日志压缩格式, 以降低存储空间.
             Defaults to "zip".
