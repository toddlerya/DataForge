...
data = {
    "task": {
        ...
        "mode": "edit",
        "task_id": "24f37bc5-535d-48e0-a3ba-8041832c49b4",
        "duration": "undefined 秒",
    ...
    "send": {
        ...
        "tip": "无配置，点击刷新或添加。",
        "connect_test": True,
        "connect_test_tip": "connect test success!",
        "table_test": True,
        "table_test_tip": "",
        "schemas": "public",
    },
...
with httpx.Client() as client:
    resp = client.get(
        "http://172.17.55.30/genius/generate-record/", params={"limit": "10"}
    )
    print(resp.status_code)
    print(resp.url)
    print(resp.headers)
